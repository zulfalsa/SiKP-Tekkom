...
interface LoginProps {
    status?: string;
    canResetPassword?: boolean; // Made optional
    canRegister?: boolean;      // Made optional
}
...
export default function Login({
    ...
    return (
        // Background color matched to the light lavender/gray in the image
            ...
            <Card className="w-full max-w-[550px] border-0 shadow-2xl sm:rounded-xl bg-white/80 backdrop-blur-sm dark:bg-gray-800/80">
                <CardContent className="p-8 md:p-14">
                    ...
                    <div className="mb-10 flex flex-col items-center text-center">
                        {/* Logo Container with specific styling from image */}
                        ...
                        <div className="grid gap-5">
                            ...
                            <div className="flex items-center justify-between mt-1">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <Label
                                        htmlFor="remember"
                                        className="text-sm font-normal text-gray-600 cursor-pointer dark:text-gray-400"
                                    >
                                        Remember me
                                    </Label>
                                </div>
                                ...
                                <TextLink
                                    ...
                                    className="text-sm font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 no-underline hover:underline"
                                    tabIndex={5}
                                >
                                    Forgot password?
                                </TextLink>
                    ...
                    {status && (
                        <div className="mt-6 rounded-lg bg-green-50 p-4 text-center text-sm font-medium text-green-700 border border-green-200 dark:bg-green-900/20 dark:text-green-400 dark:border-green-800">
                            {status}
                        </div>
                    )}
                </CardContent>
